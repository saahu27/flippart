...
private:
  ...
  bool CeilingArmMovetoTarget();
  bool CeilingArmMoveCartesian(std::vector<geometry_msgs::msg::Pose> waypoints, double vsf, double asf, bool avoid_collisions);

  bool CeilingWristMoveCartesian(std::vector<geometry_msgs::msg::Pose> waypoints, double vsf, double asf, bool avoid_collisions);
  ...
  moveit::planning_interface::MoveGroupInterface ceiling_arm_;
  moveit::planning_interface::MoveGroupInterface ceiling_wrist_;
  ...
  std::map<std::string, double> ceiling_arm_tray_js_ = {
      {"ceiling_shoulder_pan_joint", -0.261799},
      {"ceiling_shoulder_lift_joint", 0.10472},
      {"ceiling_elbow_joint", 1.93732},
      {"ceiling_wrist_1_joint", 1.0821},
      {"ceiling_wrist_2_joint", -1.37881},
      {"ceiling_wrist_3_joint", 0}};

  std::map<std::string, double> ceiling_arm_tray_ = {
      {"ceiling_shoulder_pan_joint", 0},
      {"ceiling_shoulder_lift_joint", -50*(PI/180)},
      {"ceiling_elbow_joint", 140*(PI/180)},
      {"ceiling_wrist_1_joint", -90*(PI/180)},
      {"ceiling_wrist_2_joint", 90*(PI/180)},
      {"ceiling_wrist_3_joint", 0}};
};
